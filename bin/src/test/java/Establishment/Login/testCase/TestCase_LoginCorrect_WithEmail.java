...
public class TestCase_LoginCorrect_WithEmail {
	WebDriver driver;
  @Test
  public void f() throws IOException {
	//login
	  ...
	  loginPage.login(LoginData.LoginFileCorrectWhitEmail());
	  
	//Assertion
	  Assert.assertEquals("hhttp://betakasb.abrestan.com/dashboard",driver.getCurrentUrl());
  }
