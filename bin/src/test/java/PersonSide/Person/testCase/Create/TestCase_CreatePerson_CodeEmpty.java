...
public class TestCase_CreatePerson_CodeEmpty {
	WebDriver driver;
  @Test
  public void f() throws IOException, InterruptedException {
	...
	//Create Person Correct with icon
	  ...
	  personPage.CreatePersonMandatory(dataPerson.CreatePerson_CodeEmpty());
	...
	//Assertion
	  ...
	  Assert.assertEquals(assertion.getText(),"لطفا کد شخص را وارد نمایید");
  }
  @BeforeMethod
