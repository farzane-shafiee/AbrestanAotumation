...
public class TestCase_CreatePerson_DisplayNameEmpty {
	WebDriver driver;
  @Test
  public void f() throws IOException, InterruptedException {
	...
	//Create Person Correct with icon
	  ...
	  personPage.CreatePersonMandatory(dataPerson.CreatePerson_DisplayNameEmpty());
	...
	//Assertion
	  ...
	  Assert.assertEquals(assertion.getText(),"فیلد نمایش طرف حساب با نام الزامی است.");
  }
  @BeforeMethod
