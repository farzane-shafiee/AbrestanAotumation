...
public class TestCase_CreatePerson_UsernameWrong {
	WebDriver driver;
  @Test
  public void f() throws IOException, InterruptedException {
	...
	//Create Person Correct with icon
	  ...
	  personPage.CreatePersonMandatory(dataPerson.CreatePerson_UsernameWrong());
	...
	//Assertion
	  ...
	  Assert.assertEquals(assertion.getText(),"این نام کاربری قبلا در سیستم ثبت شده است.");
  }
  @BeforeMethod
