...
public class TestCase_CreatePerson_LastNameEmpty {
	WebDriver driver;
  @Test
  public void f() throws IOException, InterruptedException {
	...
	//Create Person Correct with icon
	  ...
	  personPage.CreatePersonMandatory(dataPerson.CreatePerson_LastnameEmpty());
	...
	//Assertion
	  ...
	  Assert.assertEquals(assertion.getText(),"نام خانوادگی الزامی می‌باشد.");
  }
  @BeforeMethod
