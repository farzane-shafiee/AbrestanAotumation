...
public class TestCase_CreatePerson_NameEmpty {
	WebDriver driver;
  @Test
  public void f() throws IOException, InterruptedException {
	...
	//Create Person Correct with icon
	  ...
	  personPage.CreatePersonMandatory(dataPerson.CreatePerson_NameEmpty());
	...
	//Assertion
	  ...
	  Assert.assertEquals(assertion.getText(),"نام الزامی می‌باشد.");
  }
  @BeforeMethod
