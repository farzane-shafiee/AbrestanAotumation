...
public class TestCase_EditPerson_LastNameEmpty {
	WebDriver driver;
  @Test
  public void f() throws IOException {
	...
	//Edit Person Last Name Empty
	  ...
	  personPage.EditPerson(DataPerson.EditPerson_LastNameEmpty());
	  
	//Assertion
	  String alert = driver.findElement(By.xpath("/html/body/div[2]/div/div[2]/main/div/div/div/div[2]")).getText();
	  Assert.assertEquals(alert,"نام خانوادگی الزامی می‌باشد.");
  }
  @BeforeMethod
