...
public class TestCase_EditPerson_DisplayNameWrong {
	WebDriver driver;
  @Test
  public void f() throws IOException {
	...
	//Edit Person Display Name Wrong
	  ...
	  personPage.EditPerson(DataPerson.EditPerson_DisplayNameEmpty());
	  
	//Assertion
	  String alert = driver.findElement(By.xpath("/html/body/div[2]/div/div[2]/main/div/div/div/div[2]")).getText();
	  Assert.assertEquals(alert,"فیلد نمایش طرف حساب با نام الزامی است.");
  }
  @BeforeMethod
