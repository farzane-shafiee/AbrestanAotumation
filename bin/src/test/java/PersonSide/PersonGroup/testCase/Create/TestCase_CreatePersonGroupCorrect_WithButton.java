...
public class TestCase_CreatePersonGroupCorrect_WithButton {
	WebDriver driver;
  @Test
  public void f() throws IOException, InterruptedException {
	...
	//Create Person Group Correct with Button
	  ...
	  personGroupPage.CreatePersonGroup_WithButton();
	  personGroupPage.CreatePersonGroup(DataPersonGroup.CreatePersonGroup_WithButton());
	  
	//Assertion
	  String alert = driver.findElement(By.xpath("/html/body/div[2]/div/div[2]/main/div/div/div/div[2]")).getText();
	  Assert.assertEquals(alert,"گروه اشخاص شما بدرستی ایجاد گردید");
  }
  @BeforeMethod
