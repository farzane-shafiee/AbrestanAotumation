...
public class TestCase_EditPersonGroup_Correct {
	WebDriver driver;
  @Test
  public void f() throws IOException {
	...
	//Delete Person Group Correct
	  ...
	  personGroupPage.EditPersonGroup(DataPersonGroup.EditPersonGroup_Correct());
	  
	//Assertion
	  String alert = driver.findElement(By.xpath("/html/body/div[2]/div/div[2]/main/div/div/div/div[2]")).getText();
	  Assert.assertEquals(alert,"گروه اشخاص شما بدرستی ویرایش گردید");
  }
  @BeforeMethod
