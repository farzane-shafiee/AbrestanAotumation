...
public class CreateGoodsMandatory_Correct_WithButton {
	WebDriver driver;
  @Test
  public void f() throws IOException {
	...
	//Create Goods Correct with Button
	  ...
	  goodsPage.CreateGoodsMandatory(dataGoods.CreateGoodsMandatory_Correct());
