...
public class CreateGoods_CodeEmpty {
	WebDriver driver;
  @Test
  public void f() throws IOException {
	...
	//Create Goods Code Empty with Button
	  ...
	  goodsPage.CreateGoodsMandatory(dataGoods.CreateGoods_CodeEmpty());
	  
	//Assertion
	  WebElement assertion = driver.findElement(By.id("E_code"));
	  Assert.assertEquals("https://kasb.abrestan.com/persons/create",driver.getCurrentUrl());
	  Assert.assertEquals(assertion.getText(),"لطفا کد کالا/خدمات را وارد نمایید");
  }
  @BeforeMethod
